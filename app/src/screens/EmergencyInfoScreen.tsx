...
const styles = StyleSheet.create({
  ...
  chip: { borderWidth: 1, borderColor: colors.textDim, borderRadius: 20, paddingHorizontal: 14, paddingVertical: 7, marginRight: 8 },
  ...
  addInput: { flex: 1, borderWidth: 1, borderColor: colors.textDim, borderRadius: 8, color: colors.text, paddingHorizontal: 12, paddingVertical: 10, backgroundColor: colors.surface, fontSize: 14 },
  ...
  tag: { backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.textDim, borderRadius: 4, paddingHorizontal: 10, paddingVertical: 4 },
  ...
  contactCard: { backgroundColor: colors.surface, borderRadius: 10, padding: 12, marginBottom: 10, borderWidth: 1, borderColor: colors.textDim },
  ...
  contactInput: { borderWidth: 1, borderColor: colors.textDim, borderRadius: 6, color: colors.text, paddingHorizontal: 10, paddingVertical: 8, backgroundColor: colors.background, fontSize: 14, marginBottom: 8 },
  ...
  qrToggle: { borderWidth: 1, borderColor: colors.textDim, borderRadius: 8, padding: 12, alignItems: 'center', marginTop: 8 },
